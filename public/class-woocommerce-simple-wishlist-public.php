 ...
 * @subpackage WooCommerce_Simple_Wishlist/public
 */
...
class WooCommerce_Simple_Wishlist_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/woocommerce-simple-wishlist-public.js', array( 'jquery' ), $this->version, false );
